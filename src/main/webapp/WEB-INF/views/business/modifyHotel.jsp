...
<body>
    ...
    <form action="${conPath}/business.do" method="post" enctype="multipart/form-data">
	    ...
	    <input type="hidden" name="bid" value="${hotel.bid}">
		...
		<div class="btn-wrapper">
		    <button type="submit" class="my-button">수정</button>
		    <a href="${conPath}/business/myHotelPosts.do?pageNum=${paging.pageNum}" class="my-button">취소</a>
		</div>
	</form>
