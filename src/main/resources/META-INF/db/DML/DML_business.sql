...
INSERT INTO Restaurant (rName, bId, locationNo, rAddr, rTel, rLink, rInfo, rMenu, rMainImg, rSubImg_1, rSubImg_2, rSubImg_3, rLatitude, rLongitude, rPrice, requestStatus)
    SELECT 'Restaurant', 'bid', locationNo, 'Jeju', '02-1234-1234', 'www.naver.com', 'Information', 'Ollae Noodles', 'main_img.jpg', 'sub_img_1', 'sub_img_2', 'sub_img_3', 50.5, 50.5, 40000, 'P'
    FROM location
    WHERE lName = 'Jeju City' AND ROWNUM = 1;
...
-- Restaurant 수정
UPDATE Restaurant
SET rName = '식당', locationNo = (SELECT locationNo FROM location WHERE lName = '제주시' AND ROWNUM = 1), rAddr = '제주시', rTel = '02-1234-1234', rLink = 'www.naver.com', rInfo = '정보', rMenu = '국수', rMainImg = 'main_img.jpg', rSubImg_1 = 'new_sub_img_1', rSubImg_2 = 'new_sub_img_2', rSubImg_3 = 'new_sub_img_3', rLatitude = 50.5, rLongitude = 50.5, rPrice = 50000
    WHERE bId = 'bid';
