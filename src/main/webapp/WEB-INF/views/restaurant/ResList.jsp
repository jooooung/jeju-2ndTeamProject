...
<script>
	$(function() {
		...
		$('.list_info').click(function() {
			...
			location.href = '${conPath }/res/detail.do?sname=' + rname;
		});
		...
		$('#spot_tag li')
				.click(
						function() {
							...
							location.href = '${conPath}/res/list.do?pageNum=${paging.currentPage }&schitem='
			...
			<form action="${conPath }/res/list.do">
				<div class="search">
					<input type="text" name="schword" value="${param.schword }"
						placeholder="식당을 검색하세요"> <input type="submit" value="">
				</div>
			</form>
		</div>
			<div id="spot_tag">
