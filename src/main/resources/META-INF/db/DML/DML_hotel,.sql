...
INSERT INTO HRESERVATION (mID, hNAME, INDATE, OUTDATE)
    VALUES ('bbb', '그라벨호텔', '23/05/01', '23/05/03');
INSERT INTO HRESERVATION (mID, hNAME, INDATE, OUTDATE, RWHETHER)
    VALUES ('aaa', '그라벨호텔', '23/05/10', '23/05/16', 'Y');
...
-- 호텔별 예약 가능 날짜
SELECT INDATE, OUTDATE FROM HRESERVATION WHERE HNAME = '그라벨호텔' 
    AND INDATE = '23/04/21' AND (INDATE > '23/04/21' AND OUTDATE = '23/04/21')
    OR (INDATE < '23/04/21' AND '23/04/21' < OUTDATE);
