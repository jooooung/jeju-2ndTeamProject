...
<body>
	...
	<div id="detail_wrap">
		...
		<div id="title_wrap">
			<ul>
				<li>
					<img src="${conPath }/icon/spotDetail.png" class="spotDetail"><span>${detail.rname }</span>
				</li>
				<li>
	    ...
	    <div class="swiper-wrapper">
	      ...
	      <div class="swiper-slide" style="background-image: url('${conPath}/resImgFileUpload/${detail.rmainimg }');"></div>
		      <c:if test="${not empty detail.rsubimg_1}">
			      <div class="swiper-slide" style="background-image: url('${conPath}/resImgFileUpload/${detail.ssubimg_1 }');"></div>
		      </c:if>
		      <c:if test="${not empty detail.rsubimg_2}">
			      <div class="swiper-slide" style="background-image: url('${conPath}/resImgFileUpload/${detail.ssubimg_2 }');"></div>
		      </c:if>
		      <c:if test="${not empty detail.rsubimg_3}">
			      <div class="swiper-slide" style="background-image: url('${conPath}/resImgFileUpload/${detail.ssubimg_3 }');"></div>
		      </c:if>
	    </div>
