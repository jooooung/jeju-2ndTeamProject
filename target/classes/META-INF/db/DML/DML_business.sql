...
INSERT INTO Hotel (hName, bId, locationNo, hAddr, hTel, hLink, hInfo, inTime, outTime, hMainImg, hSubImg_1, hSubImg_2, hSubImg_3, hLatitude, hLongitude, hPrice, requestStatus)
    VALUES ('로텔', 'bid', (SELECT locationNo FROM (SELECT * FROM location WHERE lName = '제주시') WHERE ROWNUM = 1), '제주', '010-1234-1324', 'www.naver.com', '정보', '14:00', '11:00', 'main.jpg', 'sub_img_1', 'sub_img_2', 'sub_img_3', 50.5, 50.5, 40000, 'P');
-- Restaurant 등록
