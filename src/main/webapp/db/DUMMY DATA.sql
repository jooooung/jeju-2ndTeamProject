...
INSERT INTO restaurant (RNAME, BID, LOCATIONNO, RADDR, RTEL, RLINK, RINFO, RMENU, RMAINIMG, RSUBIMG_1, RSUBIMG_2, RSUBIMG_3, RLATITUDE, RLONGITUDE, RPRICE)
    VALUES ('올래국수', 'guk', 1, '제주특별자치도 제주시 귀아랑길 24 (연동)', '064-742-7355', 'LINK', '너 올래 안올래? 올래국수!', '해물국수',
            'main.img', 'sub1.img', 'sub2.img', 'sub3.img',  33.49710002092335, 126.5089619090469, '국수 7000원 부터');
INSERT INTO restaurant (RNAME, BID, LOCATIONNO, RADDR, RTEL, RLINK, RINFO, RMENU, RMAINIMG, RSUBIMG_1, RSUBIMG_2, RSUBIMG_3, RLATITUDE, RLONGITUDE, RPRICE)
    VALUES ('올레칠돈', 'park', 2, '제주특별자치도 서귀포시 월평하원로 20', '064-739-5533', 'LINK', 'A급 돼지들만 사용하는 진짜들의 고기집 입니다.', '제주흑돼지',
...
-- REVIEW --
insert into Review (reviewNo, mId, rTitle, rContent) values (reviewNo_seq.nextval, 'aaa', '성산일출봉 다녀왔습니다~', '새벽 4시에 기상해서 아침 일찍 산에 올랐는데 몸은 힘들었지만... 일출이 너무 아름다웠습니다 제주도 여행가시는 분들은 꼭 한번 가보셨으면 좋겠어요');
